...
var Config = {
	...
	DropStats:  {
      ...
      Quality: [],   // the item quality to log (1 - lowquality, 2 - normal, 3 - superior, 4 - magic, 5 - set, 6 - rare, 7 - unique, 8 - crafted)
      AutoLog: true      // update the readable file each run, if false press "numpad dot" to update it.
   },
