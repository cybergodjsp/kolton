...
function LoadConfig() {
	...
	*/
	...
	Config.FastPick = false; // Check and pick items between attacks
	 ...
	 /*   DropStats - log drops regardeless pickit list - Rev25/07/15   */
   /*   Log file found under "\logs\dropstats\CharName.json" and "\logs\dropstats\CharName.js"   */
   /*   ToDo: use storage based on array instead of object   */
   Config.DropStats =  {
      Enable: true,      // Switch on/off the function - bool.
      Quality: [6, 7],   // the item quality to log (1 - lowquality, 2 - normal, 3 - superior, 4 - magic, 5 - set, 6 - rare, 7 - unique, 8 - crafted)
      AutoLog: false      // update the readable file each run, if false press "numpad dot" to update it.
   };
